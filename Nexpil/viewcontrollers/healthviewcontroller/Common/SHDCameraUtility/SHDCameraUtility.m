...
//        if ([Common instance].isIncamera) {
//            // don't mirror in preview
//            resultingImage = [UIImage imageWithCGImage:[resultingImage CGImage] scale:[resultingImage scale] orientation:UIImageOrientationLeftMirrored];
//        } else {
...
//    [self.videoLayerView addSubview:blurView];
    ...
    [UIView setAnimationTransition:UIViewAnimationTransitionFlipFromRight forView:self.videoLayerView cache:YES];
