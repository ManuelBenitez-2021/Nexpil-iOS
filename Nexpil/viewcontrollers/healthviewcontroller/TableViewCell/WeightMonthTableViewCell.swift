//
//  WeightMonthTableViewCell.swift
//  Nexpil
//
...
class WeightMonthTableViewCell: UITableViewCell {
    ...
    func setInfo(dic: NSDictionary) {
        ...
        if val0106 > 0 {
            strValue0106 = String(format: "%.0f%@", val0106, unit)
        }
        if val0713 > 0 {
            strValue0713 = String(format: "%.0f%@", val0713, unit)
        }
        if val1420 > 0 {
            strValue1420 = String(format: "%.0f%@", val1420, unit)
        }
        if val2127 > 0 {
            strValue2127 = String(format: "%.0f%@", val2127, unit)
        }
        if val2830 > 0 {
            strValue2830 = String(format: "%.0f%@", val2830, unit)
        }
        ...
        print(">>>>", val0106, val0713, val1420, val2127, val2830)
