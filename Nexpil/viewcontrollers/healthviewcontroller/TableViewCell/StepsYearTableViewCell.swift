...
class StepsYearTableViewCell: UITableViewCell {
...
//    @IBOutlet weak var lblTitleGoalValue: UILabel!
    ...
    func initMainView() {
        ...
        lblTitleMonth.font = UIFont.init(name: "Montserrat", size: 15)
