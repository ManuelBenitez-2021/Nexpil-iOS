//
//  HemoglobinAlcTableViewCell.swift
//  Nexpil
//
...
class HemoglobinAlcTableViewCell: UITableViewCell {
    ...
    func setInfo(dic: NSDictionary) {
        ...
        for dic in arrayData {
            ...
            let floatAvarage = average.floatValue
