    ...
    UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "WeightMonthTableViewCell", bundle: nil), forCellReuseIdentifier: "WeightMonthTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "WeightMonthTableViewCell", for: indexPath) as! WeightMonthTableViewCell
