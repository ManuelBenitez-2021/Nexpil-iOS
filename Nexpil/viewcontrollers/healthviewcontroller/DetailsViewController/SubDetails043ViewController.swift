//
//  SubDetails043ViewController.swift
//  Nexpil
//
...
class SubDetails043ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "StepsYearTableViewCell", bundle: nil), forCellReuseIdentifier: "StepsYearTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "StepsYearTableViewCell", for: indexPath) as! StepsYearTableViewCell
...
//            UIApplication.shared.keyWindow?.addSubview((popupMoodViewController.view)!)
    ...
    func fetchSteps() {
        ...
        let array = manager.fetchStepsGetAllYearData()
        print(">>> array year:", array)
