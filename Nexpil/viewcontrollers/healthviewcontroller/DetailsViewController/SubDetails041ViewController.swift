//
//  SubDetails041ViewController.swift
//  Nexpil
//
...
class SubDetails041ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "StepsWeekTableViewCell", bundle: nil), forCellReuseIdentifier: "StepsWeekTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "StepsWeekTableViewCell", for: indexPath) as! StepsWeekTableViewCell
...
//            UIApplication.shared.keyWindow?.addSubview((popupMoodViewController.view)!)
    ...
    func fetchSteps() {
        ...
        let array = manager.fetchStepsGetAllWeekData()
