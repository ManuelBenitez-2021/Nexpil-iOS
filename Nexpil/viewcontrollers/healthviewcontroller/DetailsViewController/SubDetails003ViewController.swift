...
class SubDetails003ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "BloodGlucoseYearTableViewCell", bundle: nil), forCellReuseIdentifier: "BloodGlucoseYearTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "BloodGlucoseYearTableViewCell", for: indexPath) as! BloodGlucoseYearTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
                self.delegate?.didTapButtonAddWithSubDetails003ViewController()
