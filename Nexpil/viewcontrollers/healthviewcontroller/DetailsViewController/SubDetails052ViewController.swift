    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "WeightYearTableViewCell", bundle: nil), forCellReuseIdentifier: "WeightYearTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "WeightYearTableViewCell", for: indexPath) as! WeightYearTableViewCell
