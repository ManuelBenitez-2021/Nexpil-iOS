...
class SubDetails112ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            if arrayList.count > 0 {
                ...
                tableView.register(UINib(nibName: "LipidPanelTriglyceridesTableViewCell", bundle: nil), forCellReuseIdentifier: "LipidPanelTriglyceridesTableViewCell")
                let cell = tableView.dequeueReusableCell(withIdentifier: "LipidPanelTriglyceridesTableViewCell", for: indexPath) as! LipidPanelTriglyceridesTableViewCell
