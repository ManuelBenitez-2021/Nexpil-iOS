...
class SubDetails012ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "BloodPressureMonthTableViewCell", bundle: nil), forCellReuseIdentifier: "BloodPressureMonthTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "BloodPressureMonthTableViewCell", for: indexPath) as! BloodPressureMonthTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
//            self.delegate?.didTapButtonAddWithSubDetails012ViewController()
