//
//  SubDetails111ViewController.swift
//  Nexpil
//
...
protocol SubDetails111ViewControllerDelegate: class {
    func didTapButtonAddWithSubDetails111ViewController()
}

class SubDetails111ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    weak var delegate:SubDetails111ViewControllerDelegate?
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.fetchLipidPanel(index: "LDL")
    }
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            if arrayList.count > 0 {
                ...
                tableView.register(UINib(nibName: "LipidPanelLDLTableViewCell", bundle: nil), forCellReuseIdentifier: "LipidPanelLDLTableViewCell")
                let cell = tableView.dequeueReusableCell(withIdentifier: "LipidPanelLDLTableViewCell", for: indexPath) as! LipidPanelLDLTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            self.delegate?.didTapButtonAddWithSubDetails111ViewController()
