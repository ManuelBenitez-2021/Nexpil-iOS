//
//  SubDetails042ViewController.swift
//  Nexpil
//
...
class SubDetails042ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count > 0 {
            ...
            tableView.register(UINib(nibName: "StepsMonthTableViewCell", bundle: nil), forCellReuseIdentifier: "StepsMonthTableViewCell")
            let cell = tableView.dequeueReusableCell(withIdentifier: "StepsMonthTableViewCell", for: indexPath) as! StepsMonthTableViewCell
...
//            UIApplication.shared.keyWindow?.addSubview((popupMoodViewController.view)!)
    ...
    func fetchSteps() {
        ...
        let array = manager.fetchStepsGetAllMonthData()
        print(">>>> array month:", array)
