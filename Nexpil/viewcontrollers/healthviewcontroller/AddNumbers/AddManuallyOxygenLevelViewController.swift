//
//  AddManuallyOxygenLevelViewController.swift
//  Nexpil
//
...
protocol AddManuallyOxygenLevelViewControllerDelegate: class {
    func didTapButtonAddManuallyOxygenLevelViewController(date: Date,
                                                            time: String,
                                                            timeIndex: String,
                                                            value: String
    )
...
class AddManuallyOxygenLevelViewController: UIViewController,
UITextFieldDelegate, FSCalendarDelegate, FSCalendarDataSource, FSCalendarDelegateAppearance {
    
    weak var delegate:AddManuallyOxygenLevelViewControllerDelegate?
    ...
    */
    ...
    @IBAction func tapBtnDone(_ sender: Any) {
        if (txtValue.text?.count)! > 0 {
            ...
            self.delegate?.didTapButtonAddManuallyOxygenLevelViewController(date: sendDate,
                                                                              time: sendTime,
