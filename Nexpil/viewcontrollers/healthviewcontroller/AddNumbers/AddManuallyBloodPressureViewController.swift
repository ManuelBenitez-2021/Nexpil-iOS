//
//  AddManuallyBloodPressureViewController.swift
//  Nexpil
//
...
protocol AddManuallyBloodPressureViewControllerDelegate: class {
    func didTapButtonAddManuallyBloodPressureViewController(date: Date,
                                                          time: String,
                                                          timeIndex: String,
                                                          pressure1: String,
                                                          pressure2: String)
...
class AddManuallyBloodPressureViewController: UIViewController,
UITextFieldDelegate, FSCalendarDelegate, FSCalendarDataSource, FSCalendarDelegateAppearance {

    weak var delegate:AddManuallyBloodPressureViewControllerDelegate?
    ...
    */
    ...
    @IBAction func tapBtnDone(_ sender: Any) {
        if (txtValue1.text?.count)! > 0 &&  (txtValue2.text?.count)! > 0{
            print(">>>> sendDate        :", sendDate)
//            print(">>>> sendWhenIndex   :", sendWhenIndex)
            print(">>>> value1          :", txtValue1.text!)
            print(">>>> value2          :", txtValue2.text!)

            self.delegate?.didTapButtonAddManuallyBloodPressureViewController(date: sendDate,
                                                                            time: sendTime,
                                                                            timeIndex: sendTimeIndex,
                                                                            pressure1: txtValue1.text as! String,
                                                                            pressure2: txtValue2.text as! String)
