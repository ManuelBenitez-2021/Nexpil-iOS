//
//  VitaminPageViewController.swift
//  Nexpil
//
...
class VitaminPageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [            
            self.newVc(viewController: "FirstVitaminViewController"),
            self.newVc(viewController: "VitaminNameViewController"),
            self.newVc(viewController: "VitaminQuantityViewController"),
            self.newVc(viewController: "VitaminResultViewController"),
