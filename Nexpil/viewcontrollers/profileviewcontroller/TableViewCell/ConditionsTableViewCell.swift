...
class ConditionsTableViewCell: UITableViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if arrayList.count == 0 {
            ...
            if indexPath.row == 0 {
                ...
                return CGFloat(DataUtils.heightCondition)
            }
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count == 0 {
            if indexPath.row == 0 {
                ...
                cell.setTitle(str: "Add Condition")
            ...
            if indexPath.row == 0 {
                ...
                tableView.register(UINib(nibName: "ConditionTableViewCell", bundle: nil), forCellReuseIdentifier: "ConditionTableViewCell")
