...
class PharmaciesTableViewCell: UITableViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if arrayList.count == 0 {
            ...
            if indexPath.row == 0 {
                ...
                return CGFloat(DataUtils.heightPharmacy)
            }
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if arrayList.count == 0 {
            if indexPath.row == 0 {
                ...
                cell.setTitle(str: "Add Pharmacy")
            ...
            if indexPath.row == 0 {
                ...
                tableView.register(UINib(nibName: "PharmacyTableViewCell", bundle: nil), forCellReuseIdentifier: "PharmacyTableViewCell")
