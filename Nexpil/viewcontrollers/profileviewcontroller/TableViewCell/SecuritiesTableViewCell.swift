...
class SecuritiesTableViewCell: UITableViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell.setTitle(str: "Security")
            
            return cell
            
        } else {
            tableView.register(UINib(nibName: "SecurityTableViewCell", bundle: nil), forCellReuseIdentifier: "SecurityTableViewCell")
