...
class AppsTableViewCell: UITableViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if arrayList.count == 0 {
            ...
            if indexPath.row == 0 {
                ...
                return CGFloat(DataUtils.heightApp)
