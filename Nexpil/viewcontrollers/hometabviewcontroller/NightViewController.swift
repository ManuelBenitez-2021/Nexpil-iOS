...
class NightViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        currentDate = self.delegate!.selectDay(value: 3)
        ...
        self.delegate?.navColorChange(value: 3)
    }
                ...
                if let data = response.result.value {
                    ...
                    if result == "true"
                    {
                        ...
                        for obj in datas {
                            ...
                            let starttime = DataUtils.getTimeRange(index: 3)!.components(separatedBy: "-")[0]
                            let endtime = DataUtils.getTimeRange(index: 3)!.components(separatedBy: "-")[1]
...
extension NightViewController : IndicatorInfoProvider {
