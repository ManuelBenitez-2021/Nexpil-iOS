...
class EveningViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        currentDate = self.delegate!.selectDay(value: 2)
        ...
        self.delegate?.navColorChange(value: 2)
    }
                ...
                if let data = response.result.value {
                    ...
                    if result == "true"
                    {
                        ...
                        for obj in datas {
                            ...
                            let starttime = DataUtils.getTimeRange(index: 2)!.components(separatedBy: "-")[0]
                            let endtime = DataUtils.getTimeRange(index: 2)!.components(separatedBy: "-")[1]
...
extension EveningViewController : IndicatorInfoProvider {
